...
const en: Record<string, string> = {
  ...
  "prefModal.walkingTolerance": "Walking tolerance",
  "prefModal.walking.low": "Low",
  "prefModal.walking.medium": "Medium",
  "prefModal.walking.high": "High",
  "prefModal.transferLimit": "Transfer limit",
  "prefModal.transfer.none": "None",
  "prefModal.transfer.one": "Up to 1",
  "prefModal.transfer.two": "Up to 2",
  "prefModal.transfer.flexible": "Flexible",
  "prefModal.walkingPace": "Walking pace",
  "prefModal.pace.slow": "Slow",
  "prefModal.pace.normal": "Normal",
  "prefModal.pace.fast": "Fast",
  "prefModal.searchBreadth": "Search breadth",
  "prefModal.breadth.compact": "Compact",
  "prefModal.breadth.balanced": "Balanced",
  "prefModal.breadth.wide": "Wide",
  ...
  "home.startHereBody": "Search or tap a destination on the map, then choose a start point and request a route.",
...
const ar: Record<string, string> = {
  ...
  "prefModal.walkingTolerance": "قدرة المشي",
  "prefModal.walking.low": "منخفض",
  "prefModal.walking.medium": "متوسط",
  "prefModal.walking.high": "مرتفع",
  "prefModal.transferLimit": "حد التحويلات",
  "prefModal.transfer.none": "بدون",
  "prefModal.transfer.one": "حتى 1",
  "prefModal.transfer.two": "حتى 2",
  "prefModal.transfer.flexible": "مرن",
  "prefModal.walkingPace": "سرعة المشي",
  "prefModal.pace.slow": "بطيء",
  "prefModal.pace.normal": "عادي",
  "prefModal.pace.fast": "سريع",
  "prefModal.searchBreadth": "اتساع البحث",
  "prefModal.breadth.compact": "مضغوط",
  "prefModal.breadth.balanced": "متوازن",
  "prefModal.breadth.wide": "واسع",
  ...
  "home.startHereBody": "ابحث أو اضغط على وجهة في الخريطة، ثم اختر نقطة بداية واطلب المسار.",
